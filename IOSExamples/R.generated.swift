...
struct R: Rswift.Validatable {
  ...
  struct entitlements {
    struct keychainAccessGroups {
      static let appIdentifierPrefixComTosperyIosexamples = infoPlistString(path: ["keychain-access-groups"], key: "$(AppIdentifierPrefix)com.tospery.iosexamples") ?? "$(AppIdentifierPrefix)com.tospery.iosexamples"
  ...
  struct file {
    /// Resource file `Home.json`.
    static let homeJson = Rswift.FileResource(bundle: R.hostingBundle, name: "Home", pathExtension: "json")
    ...
    /// `bundle.url(forResource: "Home", withExtension: "json")`
    static func homeJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.homeJson
